...
export class PlayerAnimation {
    ...
    #initializeSprites() {
        ...
        // Set initial sprite directly, bypassing setNormalState's conditional logic for initialization
    ...
    setShootingState() {
        if (this.#currentState !== 'shooting') {
            ...
            // Reset timer if already shooting
            this.#animationTimer = this.#animationDuration;
    ...
    // Force animation state (for special effects)
    forceNormalState() {
        this.#currentState = 'normal';
        this.#animationTimer = 0;
